...
namespace margelo::nitro::nitrowebview {
  ...
  /**
   * A struct which can be represented as a JavaScript object (UriSource).
   */
...
namespace margelo::nitro {
  ...
  // C++ UriSource <> JS UriSource (object)
  template <>
  struct JSIConverter<margelo::nitro::nitrowebview::UriSource> final {
