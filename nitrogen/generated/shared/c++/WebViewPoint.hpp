...
namespace margelo::nitro::nitrowebview {
  ...
  /**
   * A struct which can be represented as a JavaScript object (WebViewPoint).
   */
  struct WebViewPoint final {
  public:
    double x     SWIFT_PRIVATE;
    double y     SWIFT_PRIVATE;

  public:
    WebViewPoint() = default;
    explicit WebViewPoint(double x, double y): x(x), y(y) {}

  public:
    friend bool operator==(const WebViewPoint& lhs, const WebViewPoint& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ WebViewPoint <> JS WebViewPoint (object)
  template <>
  struct JSIConverter<margelo::nitro::nitrowebview::WebViewPoint> final {
    static inline margelo::nitro::nitrowebview::WebViewPoint fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::nitrowebview::WebViewPoint(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::nitrowebview::WebViewPoint& arg) {
